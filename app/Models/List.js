...
export default class List {
  ...
  get Template() {
    return `
    <div class="col-4 border rounded shadow-lg" style="background-color: ${this.colorchoice}">
            <div class="row"><div class="col" >
              <h1>${this.listname} <button class="text-danger close mt-3" onclick="app.listController.confirmDelete('${this.id}')"><span>&times;</span></button></h1>
